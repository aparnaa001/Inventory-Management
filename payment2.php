...
$sid = $_SESSION['sid'];
$ucount = $_SESSION['ucount'];
$count = $_SESSION['count'];


if (isset($_POST['submit'])) {
    $new_count=$count - $ucount;
    $qry4 = "UPDATE `stock` SET `count` = '$new_count' WHERE `stkid` = ".$rid.";";
    $data4 = mysqli_query($con, $qry4);
    $qry = "INSERT INTO `booking`(`sid`,`cid`,`pid`,`price`,`status`,`bcount`,`date`)VALUES('$sid','$id','$pid','$price','Purchased','$ucount',CURDATE());";
    echo $qry;
            ...
            <div class="row gx-3">
                ...
                <div class="col-12">
                    <button name="submit" type="submit" class="btn btn-primary mb-3">
                        <span class="ps-3">Pay  <?php echo $price; ?></span>
